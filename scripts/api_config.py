...
sts_fieldnames = [
  'available_samples_ready', 'common_name', 'desc', 'family', 'family_representative',
  'family_representative_link', 'genome_notes', 'genus', 'infra_epithet', 'lab_work_status',
  'marked_done', 'material_status', 'order_group', 'prefix', 'project_code', 'sample_count',
  'scientific_name', 'sequencing_material_status_updated_at', 'sequencing_status',
  'species_id', 'submitted_gals', 'taxon_group', 'taxon_id', 'taxon_uri', 'tissue_depleted',
  'tissue_status', 'sequencing_status_simple', 'sequencing_status_dtol', 'sequencing_status_asg',
  'sequencing_status_ergapi', 'sequencing_status_vgp', 'sequencing_status_blax',
  'sequencing_status_durb', 'sequencing_status_rnd', 'sequencing_status_lawn',
